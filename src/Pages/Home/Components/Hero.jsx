...
const Hero = () => {
  return (
    <div className="px-[4.17%] md:w-11/12 mx-auto py-10 lg:py-32 md:px-10 lg:px-16 flex relative home-hero-gradient">
      <div className="flex flex-col items-center md:items-start relative z-10">
        ...
        <button
          data-aos="fade-up"
          className="transition-colors duration-500 text-center text-brand-secondary border border-white hover:border-brand-secondary hover:text-white hover:bg-brand-secondary py-4 w-[185px] bg-white font-medium rounded-sm mt-10"
        >
          Contact our team
        </button>
      </div>
