  ...
  return (
    <div className="px-[4.17px] py-10 lg:py-24 md:px-10 lg:px-16 relative">
      <div className="w-11/12 mx-auto relative z-10">
        ...
        <h1 className="text-primary text-2xl md:text-5xl font-light mb-16 max-w-[840px] leading-[120%]">
        ...
        <div className="lg:flex justify-between">
          <div className="lg:w-[45%] flex flex-col items-center lg:items-start">
            ...
            <h1 className="text-center lg:text-left text-2xl md:text-[40px] text-primary font-light mb-4 lg:max-w-[450px] leading-[120%]">
              Leveraging the power of digital payments
            </h1>
            <p className="text-center lg:text-left text-base md:text-lg text-secondary font-light mb-8 lg:max-w-[450px]">
          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start">
            <div className="mt-12 pb-12 border-b border-default w-full">
              <h1 className="stats-home-gradient text-6xl md:text-9xl mb-2">
                <CountUp
                  enableScrollSpy
                  scrollSpyOnce
                  start={0}
              ...
              <p className="text-light text-secondary">Acquiring volume</p>
            </div>
            <div className="mt-12 pb-12 border-b border-default grid grid-cols-2 gap-10 w-full">
              ...
              <div>
                ...
                <p className="text-light text-secondary">Years of experience</p>
              </div>
            </div>
            <div className="mt-12 pb-12 border-b border-default grid grid-cols-2 gap-10 w-full">
              <div>
                ...
                <p className="text-light text-secondary">Cards hosted</p>
              </div>
              <div>
                <h1 className="stats-home-gradient text-5xl md:text-7xl mb-2">
                  <CountUp
      ...
      <div className="absolute top-0 right-0 bottom-0 lg:w-4/5 ml-7">
        <img className="w-full h-full" src="/assets/images/home/about.png" alt="" />
      </div>
    </div>
  );
};
