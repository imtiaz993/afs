...
const Support = () => {
  return (
    <div className="w-11/12 lg:w-10/12 mx-auto py-10 lg:py-24 pb-0 lg:pb-0">
        ...
        <div className="py-10 px-8 rounded border border-default flex flex-col justify-between">
            ...
            <div>
              ...
              <div className="mb-8">
                <div className="flex items-center mb-1">
                  <p className="text-secondary font-light">Bahrain</p>
                  <a
                    href="http://wa.me/+973 1729 9444"
                    className="flex items-center"
                  >
                    <p className="ml-2 text-brand-secondary font-light  pr-2 mr-2 border-r border-default">
                      +973 1729 9444
                    </p>
                    <Image
                      sizes="100vw"
                ...
                <div className="flex items-center mb-1">
                  <p className="text-secondary font-light">Oman</p>
                  <a href="tel:+973 1729 9444">
                    <p className="ml-2 text-brand-secondary font-light">
                      +973 1729 9444
                    </p>
                  </a>
                </div>
                <div className="flex items-center mb-1">
                  <p className="text-secondary font-light">Egypt</p>
                  <a href="tel:+20 17119">
                    <p className="ml-2 text-brand-secondary font-light">
                      +20 17119
                    </p>
          ...
          <div>
            ...
            <a href="mailto:merchantsupport@afs.com.bh">
              <p className="text-brand-secondary">merchantsupport@afs.com.bh</p>
            </a>
          </div>
        </div>
        <div className="py-10 px-8 rounded border border-default flex flex-col justify-between">
