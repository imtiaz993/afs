          ...
          <div>
            <div className="banks-home-gradient rounded">
              ...
              >
                ...
                <p className=" text-base md:text-lg text-white mb-4 max-w-[420px] opacity-80">
            ...
            <div className="all-solution-home-gradient mt-4 rounded overflow-hidden">
              ...
              >
                ...
                <p className=" text-base md:text-lg text-primary mb-8 max-w-[425px] opacity-80">
          ...
          <div>
            <div className="bg-[#7A7A7A] rounded relative">
              <div className="p-6 md:px-10 py-12 rounded relative z-10">
                ...
                <p className=" text-base md:text-lg text-white mb-8 max-w-[420px] opacity-80">
                  Effortlessly receive your salary, access your personalized
                  card, and securely transfer funds to others. Simplify your
                  finances with BPay wallet.
                </p>
                <div className="">
