        ...
        <div className="xl:w-1/2 lg:max-w-[700px] flex flex-col items-center lg:items-start">
          ...
          <Link href="/careers">
            <button
              ...
              className="transition-colors duration-500 text-center text-white py-[11.2px] w-48 bg-brand-secondary hover:text-brand-secondary border border-brand-secondary hover:bg-white font-medium rounded-sm"
            >
              View careers page
            </button>
          </Link>
