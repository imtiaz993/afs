export const faqContentData = [
  {
    ...
    content: `
    <p class="text-secondary mt-2 text-sm md:text-base !leading-[150%]">
  ...
  {
    title: "How do APIs work? and are AFS's APIs secure?",
    content: `
    <p class="text-secondary mt-2 text-sm md:text-base !leading-[150%]">
    ...
    <p class="text-secondary mt-4 text-sm md:text-base !leading-[150%]">
  ...
  {
    title: "What does bank coverage mean?",
    content: `
      <p class="text-secondary mt-2 text-sm md:text-base !leading-[150%]">
  ...
  },
  {
    ...
    content: `
      <p class="text-secondary mt-2 text-sm md:text-base !leading-[150%]">
          An Open Banking primary business contact is a designated point of contact for business-related issues related to Open Banking. It is responsible for ensuring that business requirements and specifications are met, and for resolving any business issues that may arise. For AFS you may contact us at <a class="text-brand-secondary hover:underline" href="mailto:openbanking@afs.com.bh">openbanking@afs.com.bh</a>
      </p>
      `,
  },
  {
    title:
      "I have an existing product for this I require Open Banking APIs for better service to my end users, how can this be done?",
    content: `
      <p class="text-secondary mt-2 text-sm md:text-base !leading-[150%]">
          You may contact the Open Banking primary business contact over an email <a class="text-brand-secondary hover:underline" href="mailto:openbanking@afs.com.bh">openbanking@afs.com.bh</a>, alternatively you can request signup on our website <a class="text-brand-secondary hover:underline" href="https://openbanking.afs.com.bh">https://openbanking.afs.com.bh</a> and get access to the APIs sandbox to get started with Open Banking APIs and use cases.
      </p>
      `,
  },
];
