...
const AFSOneFoodAndBeverage = () => {
	const benefitsData = [
		...
		},
		{
			...
			icon: "/assets/icons/solutions/solution-banks/card-issuing-processing/enhanced-customer-service.svg",
		},
		{
			title: "Scalability",
			description:
			...
			icon: "/assets/icons/solutions/solution-banks/card-issuing-processing/scalability.svg",
		},
		{
	...
	const featuresData = [
		{
			...
			image:
				"/assets/images/solutions/business/food-beverage/order-management2.png",
		},
		{
		...
		},
		{
			...
			image:
				"/assets/images/solutions/business/food-beverage/menu-pricing-customization2.png",
		},
		{
			...
			image:
				"/assets/images/solutions/business/food-beverage/guest-management2.png",
		},
		{
			...
			image:
				"/assets/images/solutions/business/food-beverage/branch-integration2.png",
		},
		{
			...
			image:
				"/assets/images/solutions/business/food-beverage/seamless-integration2.png",
		},
	];
	return (
		<>
			...
			<CommonHero
				...
				image={
					"/assets/images/solutions/business/food-beverage/food-beverage-banner.png"
				}
