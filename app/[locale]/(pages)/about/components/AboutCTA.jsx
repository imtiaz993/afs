      ...
      <div className="my-10 lg:my-0 bg-brand-surface px-4 md:px-10 lg:px-16">
        <div className="w-full flex justify-between items-center py-10 lg:py-24">
          <div className="xl:w-1/2 lg:max-w-[700px] flex flex-col items-start">
            ...
            <p className="text-left text-base md:text-lg text-brand-primary mt-6 mb-6 !leading-7">
            ...
            <Link href="/careers" className="w-full md:w-auto">
              <button className=" text-center text-white py-[11px] w-full md:w-48 bg-brand-secondary  border border-brand-secondary transition-colors duration-300 hover:bg-brand-primary hover:border-brand-primary font-medium rounded-sm">
                View careers page
              </button>
            </Link>
          </div>
