...
const JobDetails = ({ data }) => {
  return (
    <div className="md:w-48 mb-10 md:mb-0">
      <div className="mb-6">
        <h5 className="text-lg text-primary !leading-6font-medium !leading-7">
          Location
        </h5>
        <p className="text-primary !leading-6">{`${data.location?.city}, ${data.location?.country}`}</p>
      </div>
      <div className="mb-6">
        <h5 className="text-lg text-primary !leading-6font-medium !leading-7">
          Type
      ...
      <div className="mb-8">
        ...
        <p className="text-primary !leading-6">{data.department}</p>
      </div>
      <button
