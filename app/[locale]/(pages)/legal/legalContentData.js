export const legalContentData = [
  {
    ...
    <h5 class="text-[18px] font-[400] !leading-[25.2px] text-primary mt-8">
      Access
    </h5>
    <p class="text-secondary mt-4 text-[18px] font-[400] !leading-[28px]">
  ...
  },
  {
    ...
    <p class="text-secondary mt-4 text-[18px] font-[400] !leading-[28px]">
      The “AFS Group” includes Arab Financial Company B.S.C (c) and any entities wholly or more than 51% owned by it. For more information about the AFS Group, including who is a member of it, you may visit <a href="https://www.afs.com.bh/" class="text-brand-secondary hover:underline">https://www.afs.com.bh/</a> or contact your Relationship Manager.
    </p>
    ...
    <p class="text-secondary mt-4 text-[18px] font-[400] !leading-[28px]">
      ...
      <ul class="space-y-1 ml-10 mt-2 list-disc text-secondary text-sm md:text-base !leading-[150%]">
        <li>
  ...
  <p class="text-secondary mt-4 text-[18px] font-[400] !leading-[28px]">
    ...
    <p class="text-secondary mt-4 text-[18px] font-[400] !leading-[28px]">
      ...
      <ul class="space-y-1 ml-10 mt-2 list-disc text-secondary text-sm md:text-base !leading-[150%]">
        ...
        <li>
          E-mail: <a href="mailto:privacy@afs.com.bh" class="text-brand-secondary hover:underline">privacy@afs.com.bh</a>
        </li>

        <li>
          For more information about AFS please visit our website <a href="https://www.afs.com.bh" class="text-brand-secondary hover:underline">https://www.afs.com.bh</a> 
        </li>
  ...
  },
  {
    ...
    <p class="text-secondary mt-4 text-[18px] font-[400] !leading-[28px]">
       Thank you for visiting <a href="www.afs.com.bh" class="text-brand-secondary hover:underline">www.afs.com.bh</a>("Website"). This policy explains how cookies are used on our website. This policy may be  amended from time to time and the latest policy will be posted on this page.
    </p>
    ...
    <p class="text-secondary mt-4 text-[18px] font-[400] !leading-[28px]">
     ...
     <h5 class="text-[20px] font-[400] !leading-[25.2px] text-primary mt-8">
      ...
      <h5 class="text-[20px] font-[400] !leading-[25.2px] text-primary mt-12">
      ...
      <ul class="space-y-1 ml-10 mt-2 list-disc text-secondary text-sm md:text-base !leading-[150%]">
        <li>
          Cookie setting in <a href="https://support.apple.com/en-gb/guide/safari/sfri11471/mac" target="_blank" class="text-brand-secondary hover:underline">Safari</a> 
        </li>

        <li>
          Cookie setting in <a href="https://support.microsoft.com/en-gb/windows/manage-cookies-in-microsoft-edge-view-allow-block-delete-and-use-168dab11-0753-043d-7c16-ede5947fc64d" target="_blank" class="text-brand-secondary hover:underline">Internet Explorer</a> 
        </li>

        <li>
          Cookie setting in <a href="https://support.google.com/chrome/answer/95647?co=GENIE.Platform%3DDesktop&hl=en" target="_blank" class="text-brand-secondary hover:underline">Chrome</a> 
        </li>
  ...
  },
  {
    ...
    <ul class="space-y-1 ml-10 mt-2 list-disc text-secondary text-sm md:text-base !leading-[150%]">
        <li>
         "<b>Beneficiary</b>" refers to the person(s) that the User designates to receive the funds from the Remittance Transaction. 
        </li>

        <li>
         "<b>BPay Card</b>" means the virtual card issued by AFS to the User which is linked to the Wallet Account and includes reference to Supplementary Cards. 
        </li>


        <li>
         "<b>Call Centre</b>" refers to the customer care telephonic helpline, email provided by AFS. 
        </li>

        <li>
         "<b>Charges</b>" means any amount payable by the User arising from the issue and use of the Wallet or BPay Card(s) or the Card number or the PIN or otherwise under these Terms and includes without limitation, all fees, charges, interest, expenses, damages and legal costs and disbursements arising from a Transaction and also refers to any third party levies, or charges, including of Card Scheme. 
        </li>

        <li>
         "<b>Card Scheme</b>" means payment networks like Visa /MasterCard /Union Pay or any local network such as Benefit Co. etc. 
        </li>

        <li>
         "<b>Content</b>" means software (including machine images), function, application, data, text, audio, video, or images, products or services. 
        </li>

        <li>
         "<b>International Remittance</b>" and “International Money Transfer” refers to the cross-border transfer of funds by a User to a registered beneficiary designated as a Remittance Transaction.  
        </li>

        <li>
         "<b>International Remittance Transaction</b>" refers to the cross-border payment of funds in Bahraini Dinars that the User requests and authorizes for the purposes of delivering foreign currency funds to the registered beneficiary.  
        </li>

        <li>
         "<b>Our</b>" or <b>We</b> or <b>Us</b> refers to AFS. 
        </li>

        <li>
         "<b>Remittance Quote</b>" or <b>Remittance Quotation</b> refers to the cross-border declaration of the foreign currency exchange rate or foreign currency amount that will be delivered to the registered beneficiary which the User must accept before proceeding with any cross-border payment.
        </li>

        <li>
         "<b>Services</b>" refers to the products and services made available to the Users through the Wallet App and use of which is subject to these Terms and includes references to Third Party Content.
        </li>

         <li>
         "<b>Transaction</b>" means any transaction including funding, payment or transfer made on or through the use of the Wallet Account, BPay Card including but not limited to purchase or payments made within the Wallet App (“In-App” purchases), cash withdrawal, International Remittance, transfer, bill payments, or any payment at merchant locations or online or ecommerce transaction, refund or any other use of the Wallet Account, Card or Card number.
        </li>

        <li>
         "<b>Third Party Content</b>" means the Content made available to you by any third party on AFS Card or in conjunction with the Services.
        </li>

        <li>
         "<b>You</b>" or <b>Your</b> or <b>User</b> refers to you as a person who has registered and authorized for availing the Services through the Wallet. 
        </li>

        <li>
         "<b>Wallet</b>" means the stored value or prepaid account provided by AFS under the name and style BPay. All references to Wallet  herein includes references to BPay Card, unless repugnant to the context or meaning thereof.   
        </li>


        <li>
         "<b>Wallet App</b>" means BPay mobile application which can be downloaded by the User through Play Store to Apple Store on a mobile.   
        </li>
        
        <li>
         "<b>Wallet Account</b>" means the BPay account registered and maintained with AFS.   
        </li>
      </ul>
        ...
        <h5 class="text-[18px] font-[400] !leading-[25.2px] text-primary mt-8">
          ...
          <ol class="space-y-1 ml-10 mt-2 list-decimal text-secondary text-sm md:text-base !leading-[150%]">
              <li>
                You consent, on Your own behalf and on behalf of any third-party individuals (e.g., beneficial owners, cardholders that You use, etc.) to the collection, use, processing, and disclosure of any Personal Data. 
              </li>
              ...
              <li>
               	AFS will use your Personal Data where we have your consent as provided hereunder or when we have another lawful reason such as:
              ...
              <li>
                  Where you provide any Personal Data relating to third party individuals to AFS, you represent and warrant that you have:
           ...
           <h5 class="text-[18px] font-[400] !leading-[25.2px] text-primary mt-8">
            ...
            <ol class="space-y-1 ml-10 mt-2 list-decimal text-secondary text-sm md:text-base !leading-[150%]">
              ...
              <li>
                <h5 class="text-[18px] font-[400] !leading-[25.2px] text-primary mt-8">
                  Payments And Delivery of Funds  
                </h5>
              ...
              <li>
                <h5 class="text-[18px] font-[400] !leading-[25.2px] text-primary mt-8">
                  Foreign Exchange Quotation or Foreign Exchange Rate   
                </h5>
          ...
          <h4 class="text-[24px] font-[400] !leading-[31.2px] text-primary mt-8">
            Schedule 1
          </h4>
  ...
  },
  {
    ...
    <ul class="space-y-1 ml-10 mt-2 list-disc text-secondary text-sm md:text-base !leading-[150%]">
      <li>
       “<b>Acquirer</b>” - means a person who supplies Acquiring Services to the Merchant under this Agreement where that person is AFS;   
      </li>

      <li>
       “<b>Acquiring Services</b>” means the deployment of various modes of payment acceptance, including POS Terminal, and includes Card Acquiring and acquiring payment based on quick response code (QR Code), Transactions Authorisation, and processing of Settlement files related to Transactions, and processing of Chargebacks, Refunds, Representments, Retro-Charges as applicable and Settlement to the Merchants;
      </li>

     <li>
       “<b>Account(s)</b>” means any mobile digital wallet or any other QR Code based payment account, virtual card account, or a mobile payment account and any additional or other valid payment account issued by an Issuer, either as closed loop or under one of the Schemes as may be updated, modified, or replaced and notified by AFS to the Merchant in writing from time to time; 
      </li>

       <li>
       “<b>Access ID</b>” means the unique alphanumeric/numeric code for the Merchant’s account with AFS.
      </li>

      <li>
       “<b>AFS</b>” means Arab Financial Services Co. B.S.C (c), including any successor business or any other person Arab Financial Services Co. B.S.C. (c) may transfer or assign its rights and/or obligations to;
      </li>

      <li>
       “<b>AFS’s Authorisation Center</b>” means the center administered by or on behalf of AFS and contactable 24 hours a day, seven (7) days a week, which the Merchant should contact by telephone at +973 17 299 444 (or such other number as may be notified by AFS to the Merchant from time to time) to obtain authorization in the event of query or doubt as to the validity of any card or transaction;
      </li>

      <li>
       “<b>Agreement</b>” means this AFS Merchant Agreement, the Schedules, Application Form, Schedule of Charges, Scheme Rules Operating Guide, Privacy Notice, and any additional terms and conditions, manuals, policies, procedures and documents that apply to the Merchant, in each case as may be amended, updated, or replaced from time to time;
      </li>

       <li>
       “<b>Application Form</b>”means the application form that the Merchant submits when applying for the provision of Services, setting out the Merchant’s selection of Services and Charges for the Services, which are subject to change from time to time; the Application Form may carry a branding name of AFS bundled offers, such as “AFS GO APPLICATION FORM” or any other branded or bundled packages offered by AFS, from time to time;
      </li>

      <li>
       “<b>Authorisation</b>” means in case of the acquired Services, the confirmation at the time of a trnsaction from the relevant Issuer that the Card used to pay for the Transaction has not been blocked for any reason or listed as lost or stolen or as having had its security compromised and that there are sufficient funds available for the relevant Transaction; and “Authorise” and “Authorised" shall be construed accordingly;
      </li>

      <li>
       “<b>Bahraini Dinars</b>” or “<b>BHD</b>” means the lawful currency of the Kingdom of Bahrain;
      </li>

      <li>
       “<b>Bank Account</b>”means the valid account held by the Merchant under this Agreement, as provided by the Merchant
      </li>


      <li>
       “<b>BPay</b>” refers to AFS own branded Account issued to Account Holders approved by AFS.”
      </li>

       <li>
       “<b>Business Day</b>” means any day other than a Friday and a Saturday or a public holiday on which banks and other financial institutions are open for business in the kingdom of Bahrain;
      </li>

       <li>
       “<b>Card(s)</b>” means any valid payment card or other valid payment mode in any card category (debit card, credit card, charge card, commercial card, or prepaid card) used by an Issuer under a Scheme whose payments AFS is able to process(as notifed by AFS to the Merchants from time to time) and includes an Account. All references to Card in this Agreement shall include references to Accounts and all references to Cardholder shall include references to Account holder; 
      </li>

      <li>
       “<b>Cardholder(s)</b>” means any person who is entitled to use the Card or to whom the Card has been issued by the issuer and who is a customer purchasing goods and/or services from the Merchant; 
      </li>

      <li>
       “<b>Card-Not-Present Transaction(s)</b>” or “CNP Transaction” means a Transaction by a Cardholder where the Cardholder is not physically present at the Merchant Outlet at the time of the Transaction and it comprises telephone order or mail order Transaction; 
      </li>

      <li>
       “<b>Chargeback</b>” means any circumstances where Issuers, Schemes and/or other financial institutions either refuse to Settle a Transaction or demand payment from Acquirer in respect of a Transactions that has been Settled and/or in respect of which payment has been made to the Merchant notwithstanding any Authorisation
      </li>

      <li>
       “<b>Chargeback Fee</b>” means fee charged by AFS for processing a Chargeback, any reasonable cost or expenses or assessments incurred by AFS as a result of or in connection with a Chargeback;
      </li>
      ...
      <li>
       “<b>Charges</b>” means all fees, charges or costs payable for the Services  and other charges or fees specified in the Application Form and Schedule of Charges, including but not limited to merchant services fees (MSF), transaction fees, Chargeback fees, Fall Below Fee etc.; 
      </li>

      <li>
       “<b>Chip-and-PIN</b>” means all face-to-face Transactions processed in line with the Chip-and-PIN program;
      </li>
      ...
      <li>
       "<b>Control</b>" or "<b>Controlled</b>" means the exercise, or ability to exercise, or entitlement to acquire, direct or indirect control over a body corporate, and a "Change of Control" shall be deemed to have occurred if any person or persons who control(s) the body corporate at the Effective Date subsequently cease to control the body corporate;
      </li>

      <li>
        “<b>DCC</b>” means the dynamic currency conversion process whereby the Merchant accepts a Transaction either in the currency of the Cardholder’s Card or the local currency;
      </li>

       <li>
        "<b>DCC Currency</b>" means the currency of the Foreign Cardholder's country of issue and/or billing currency and is denominated by the Card;
      </li>

      <li>
        “<b>ECR</b>” refers to Electronic Cash Register;
      </li>


      <li>
        "<b>Effective date</b>" means the date the Merchant signs the Application Form and the date on which the Merchant has been notified by AFS (at our sole and absolute discretion) that the Merchant's application for provision of Services has been accepted;
      </li>

      <li>
        "<b>Equipment</b>" means the POS Terminal and hardware equipment, software, and other electronic computer and telecommunications devices and equipment (including any Chip-and-PIN processing equipment) or any application (in the case of SoftPOS) provided by AFS to the Merchant to process any Transaction;
      </li>

      <li>
        "<b>e-Channels</b>" means the online interface supported by the Merchant to connect Customers to AFS's Payment Gateway system, which may also include the use of mobile banking, Interactive Voice Response (IVR) and POS Terminals.
      </li>

      <li>
        "<b>Fall Below Fee</b>" means Fee charged by AFS to Merchants who do not transact or transact below a set threshold based on the minimum value amount set by AFS in the Application Form;
      </li>

       <li>
        "<b>Floor Limit</b>" means any monetary limit (of which we notify you from time to time) above which the Merchant must obtain AFS's Authorisation prior to completing a Transaction;
      </li>

      <li>
       "<b>Foreign Cardholder(s)</b>" means a Cardholder of a Card where the currency of the Card's country of issue and/or billing currency is not the local currency of Bahrain and the Card Scheme uses DCC. "Foreign Transaction" shall mean the Transaction conducted by a Foreign Cardholder
      </li>

      <li>
       "<b>Hospitality Industry</b>" means any category or field within the broad range of service-oriented industries, which includes hotels and lodgings, the food and beverage industry, event planning, theme parks, transportation, cruise lines, and other businesses in the tourism industry, car or vehicle rental services;
      </li>

      <li>
      "<b>Intellectual Property Rights</b>" means any patents, inventions, know-how, trade secrets, and other Confidential Information, registered designs, copyrights, software,database rights, design rights, moral rights, trademarks,service marks, images, logos, domain names, businessnames, or trade names, and all other intellectual property and neighboring rights and similar rights in any part ofthe world (whether or not registered or capable of registration);
      </li>

      <li>
       "<b>In-Application Payment</b>" means payment made within the application of an Account (for example, game ..."
      </li>

      <li>
       “<b>Issuer</b>” means the institution who issues Cards;
      </li>

     <li>
        "<b>KYC Details</b>" means the know your customer information that is required to be fumished by the Merchant to AFS from time to time with regard to the Merchant's ownership, business, and operations in accordance with the CBB requirements and Scheme Rules;
      </li>

      <li>
        "<b>Law</b>" means a laws or regulations (Incuding the requirements of any Regulatory Authority) applicable to a Party (including a Party's rights or obligations) or to any Transaction or Refund for the time being in force in a jurisdiction;
      </li>

      <li>
        '<b>Merchant</b>" means the person to whom AFS has authorised the use of the Services pursuant to the application Form signed by the Merchant, and unless the context otherwise requires, includes the Merchant's directors, employees, staff, agents, subcontractors, or anyone acting on the Merchant's behalf and the Merchant's heirs after the Merchant's death (this does not apply to companies) and the Merchant's successors and approved assignees. If two or more persons are referredto as"Merchants,"each shall be liable individually as well as jointly;
      </li>

      <li>
        "<b>Merchant Outlet</b>" means the physical retail outlet (or department) owned and operated by the Merchant in the Kingdom of Bahrain and which is agreed with the Merchant and/or any other outlets (or departments) as may be agreed by AFS in writing;
      </li>

      <li>
        '<b>Minimum Annual Transaction Volume</b>" means the expected Transaction volume agreed with the Merchant in the Application Form over a certain period of time,such as monthly quarterly , or annually;
      </li>

      <li>
        "<b>Network Outage</b>" means any time in which no traffic can pass in, out, or between AFS's Payment Gateway Equipment and/or the Merchant's web server hosting the e-Commerce website for more than fifteen (15) consecutive minutes.
      </li>

      <li>
       "<b>Offline Transaction</b>" means a Transaction where an authorization is obtained manually through the AFS Authorisation Center and requires the signature of the Cardholder;
      </li>

      <li>
       "<b>Operating Guide</b>" means any operating guides (including but not limited to any instructions, guides or manuals) which AFS makes available to the Merchant as amended, updated, or replaced from time to time;
      </li>

       <li>
       “<b>Party</b>” means each AFS and the Merchant, and “Parties” means AFS and the Merchant together;
      </li>

       <li>
       "<b>PCI DSS</b>" means the Payment Card Industry Data Security Standards which apply as amended, updated or replaced from time to time, including 3-D Secure to improve the security of CNP Transactions. Details can be found at <a href="https://www.pcisecuritystandards.org" class="text-brand-secondary hover:underline" target="_blank">https://www.pcisecuritystandards.org</a> or any other location that the Merchant may be notified of from time to time;
      </li>

      <li>
      "<b>Payment Link</b>" means the application allows sending customers electronic invoices (via email, SMS, copy link to post on other social media) with a "Pay Now" button to seamlessly pay;
      </li>

      <li>
        "<b>Payment Gateway Services</b>" means the gateway services offered by AFS in accordance with the Schedule 1 to this Agreement, which provide the Merchant with the software and connectivity to allow real-time secure payment data transmission for processing of Card payments on the Merchant's website or mobile application;
      </li>

      <li>
        “<b>Payment Gateway Transaction</b>” means the Transaction made using Payment Gateway Services;
      </li>

      <li>
        “<b>PAN</b>” means the Cardholder’s primary account number displayed on the Card;
      </li>

      <li>
        "<b>Personal Data</b>" means any information relating to any individual who can be identified, directly or indirectly, in particular by reference to an identifier such as a name, an identification number, location data, an online identifier, or to one or more factors specific to the physical, physiological, genetic, mental, economic, cultural, or social identity of that individual and includes Transactional Data and Security Code;
      </li>

      <li>
        "<b>PIN</b>" means the Cardholder's personal identification number on the Card;
      </li>

      <li>
        "<b>POS Terminal</b>" means the authorised point of sale machines and associated equipment or devices owned and operated by AFS to receive Card payments and record Transaction Data, which includes SoftPOS;
      </li>

      <li>
        “<b>POS Record</b>” or “<b>Receipt</b>” means the printed receipt of any Transaction (approved, referral, or declined Transaction);
      </li>

      <li>
       “<b>Privacy Notice</b>” means AFS’s privacy statement as updated from time to time by AFS and which is made available at <a href="www.afs.com.bh" class="text-brand-secondary hover:underline">www.afs.com.bh</a>;
      </li>

      <li>
       "<b>QR Code</b>" means a machine-readable code consisting of an array of black and white squares, typically used for storing URLs or other information for reading by the camera on a smartphone;
      </li>

      <li>
       “<b>Recurring Transaction</b>” means a repetitive periodic Transaction for which the Merchant charges the Card or Account (e.g., subscriptions or instalments);
      </li>

      <li>
       “<b>Refund</b>” means a refund given to the Cardholder or the Account Holder by the Merchant of a payment for credit to that Cardholder’s or Account Holder’s account;
      </li>

      <li>
       “<b>Representment</b>” means a Transaction to reverse a Chargeback by the re-execution of the original Transaction, where the Merchant has successfully challenged the Chargeback;
      </li>

      <li>
      "<b>Regulatory Authority</b>" means any govemmental or regulatory authority, and/or any self-regulatory authority, governmental department, agency, commission, board' tribunal, crown corporation, or court, or other law, rule, or regulation-making entity with jurisdiction over any of the' Parties and/or their businesses or any part or subdivision thereof in any territory in which the Services are made available or any local authority, district or other subdivision thereof (including, in respect of Bahrain, the Central Bank of Bahrain (CBB), Ministry of Industry, Commerce and Tourism, and any other body which succeeds or replaces any of the foregoing);
      </li>

       <li>
        “<b>Retro-Charge</b>” means a Transaction initiated by the Merchant to reverse a Refund to which the Cardholder or Account Holder was not entitled;
      </li>
      ...
      <li>
        “<b>Scheme(s)</b>” means payment schemes networks linked to payment cards, facilitating electronic funds transfers and governing the issue and use of the scheme branded Cards, as may be approved and notified by AFS to the Merchant in writing from time to time, such as Visa Inc; MasterCard; Amex, UPI etc.
      </li>

      <li>
        "<b>Settlement</b>" means any payment AFS makes to the Merchant under this Agreement in the course Of Acquiring Services or any Value-Added Services (and "Settle" and "Settled" will be construed accordingly);
      </li>

      <li>
        "<b>Settlement Date</b>" means the Business Day (notified to the Merchant by AFS from time to time) on which the Settlement occurs;
      </li>

      <li>
        "<b>Scheme Rules</b>" means the collective set of bylaws, rules, regulations, operating regulations, policies, procedures, guidelines, and manuals issued by (or in relation to) AFS and/or any Scheme and/or any Other Scheme, as may be amended, updated, or replaced from time to time, and which shall form an integral part of this Agreement as if annexed to or set out in the body of this Agreement in full;
      </li>

      <li>
       "<b>Schedule of Charges</b>" means the document(s) outlining charges payable by the Merchant to AFS in connection with the Services, whether attached to or included within the Application Form, and/or otherwise provided by AFS to the Merchant from time to time;
      </li>

      <li>
        "<b>Security Code</b>" means security related information used to authenticate Cardholders and authorise Card transactions and includes any of the following contained in a Card: the contents of the magnetic stripe; the Card verification value in the magnetic stripe or in a chip; the Card security code; and the PIN verification value contained in the magnetic stripe;
      </li>

      <li>
        "<b>Services</b>" means any or all of the Acquiring Services, the Value-add Services and/or the POS Terminal hire services that are provided to the Merchant by AFS under this Agreement;
      </li>

      <li>
        "<b>“SoftPOS</b>" means the payment software application provided by AFS to the Merchant to accept Transactions using a Card and/or Payment Links on the Merchant's mobile device;
      </li>
      ...
      <li>
        "<b>Surcharge</b>" means any additional charge or payment added by the Merchant to the Cardholder making a Card payment, and which is prohibited by law;
      </li>

      <li>
        "<b>Term</b>" means the duration for which this Agreement shall be valid for each Merchant. The Term of this Agreement shall commence on the Effective Date and continue for 3 (three) years, and auto-renews for consecutive terms of 3 (three) years each;
      </li>

      <li>
        "<b>Transaction</b>" means any payment howsoever accept-ed, whether through Payment Gateway Services, CNP, POS Terminal, SoftPOS, In-Application Payments and any other mode of acceptance provided under the Services to the Merchant, which payment can be made using either: (a) a Card, a Card number, or otherwise to debit or credit the applicable Card account; or (b) a payment through an Account; in each case, in accordance with the terms of this Agreement and in relation to which AFS supplies any of the Services to Merchant, or a reversal of the same. Unless the context requires otherwise, a reference to "Transaction" shall include a reference to a Refund, a Representment, a Retro-Charge, a Recurring Transaction, and a series of connected Transactions;
      </li>

      <li>
        “<b>Transaction</b>” shall include a reference to a Refund, a Representment, a Retro-Charge, a Recurring Transaction, and a series of connected Transactions;“<b>Transaction Data</b>” means Personal Data comprised in a particular Transaction and any other data relating to the Transaction, including the value of the Transaction and the Card information;
      </li>

      <li>
        '<b>Tax</b>" means all forms of tax and statutory, governmental, state, federal, provincial, local, government or municipal charges, duties, imposts, contributions, levies, withholdings or liabilities wherever chargeable, and any penalty, fine, surcharge, interest, charges or costs relating to it and includes VAT;
      </li>

      <li>
        “<b>Turnover</b>” means the total volume of the Transactions in monetary terms measured over a period of time;
      </li>

      <li>
        "<b>Value-add Services</b>" means (i) Payment Gateway Services; (ii) DCC Services; (iii) BPay acceptance as well as (iv) any other services as AFS may specify from time to time in the Application Form, in each case excluding Acquiring Services, as more particularly described in the Schedule 1 to the Agreement.
      </li>

      <li>
        "<b>VAT</b>" means means value-added tax and any other similar tax or duty; 
      </li>
    </ul>
      ...
      <ul class="space-y-1 ml-10 mt-2 list-disc text-secondary text-sm md:text-base !leading-[150%]">
        ...
        <li>
         For all Card Payments, the Merchant must ensure the following:
          <ul class="space-y-1 ml-10 mt-2 list-[lower-latin] text-secondary text-sm md:text-base !leading-[150%]">
            <li>
      ...
      <ul class="space-y-1 ml-10 mt-2 list-disc text-secondary text-sm md:text-base !leading-[150%]">
        ...
        <li>
          The Merchant shall not accept a Transaction except for the legitimate purchases of goods and/or services provided by the Merchant during the Merchant's ordinary business, trade, and activities. This includes:
            <ul class="list-[lower-latin] space-y-1 ml-10 mt-2 text-secondary text-sm md:text-base !leading-[150%]">
                <li>
     ...
     <h5 class="text-[18px] font-[400] !leading-[25.2px] text-primary mt-8">
      ...
      <h5 class="text-[18px] font-[400] !leading-[25.2px] text-primary mt-8">
       ...
       <ul class="list-disc space-y-1 ml-10 mt-2 text-secondary text-sm md:text-base !leading-[150%]">
          <li>
       ...
       <ul class="list-disc space-y-1 ml-10 mt-2 text-secondary text-sm md:text-base !leading-[150%]">
        ...
        <ul class="list-disc space-y-1 ml-10 mt-2 text-secondary text-sm md:text-base !leading-[150%]">
          ...
          <ul class="list-disc space-y-1 ml-10 mt-2 text-secondary text-sm md:text-base !leading-[150%]">
            ...
            <li>
             Notices to AFS shall be sent to the below email address or such other address as may be notified by AFS to the Merchant in writing from time to time. AFS contact details: <a href="mailto:merchant@afs.com.bh">merchant@afs.com.bh</a>
            </li>
           ...
           <li>
              All electronic mail instructions from Merchant in relation to Services (such instructions are 
              hereinafter referred to as the "Email Instructions") shall be subject to following conditions:
          ...
          <ul class="list-disc space-y-1 ml-10 mt-2 text-secondary text-sm md:text-base !leading-[150%]">
           ...
           <h5 class="text-[18px] font-[400] !leading-[25.2px] text-primary mt-8">BPay Acceptance</h5>
        <p class="text-secondary mt-4 text-[18px] font-[400] !leading-[28px]">
