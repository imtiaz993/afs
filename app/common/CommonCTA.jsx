      ...
      <div className="w-full lg:max-w-[700px] py-10 lg:py-24 px-10 lg:pl-16 relative z-10 flex flex-col items-center lg:items-start">
        ...
        <Link href="/contact">
          <button
            ...
            className="transition-colors duration-500 text-center text-white py-[15.2px] w-44 bg-brand-secondary hover:text-brand-secondary border border-brand-secondary hover:bg-white font-medium rounded-sm"
          >
            Contact our team
          </button>
        </Link>
