            ...
            <table style="width: 100%">
              <tr>
                <td style="font-size: 0">
                  <table style="width: 75%; display: inline-block">
                    <tr>
                          ...
                          <tr>
                            <td align="top">
                              <span
                                ...
                                "
                              >
                                <p style="color: #a82c00">${category}!</p>
                              </span>
                            </td>
                            ...
                            >
                              <span
                                ...
                                "
                              >
                                <p style="color: #036fd0">Internal</p>
                              </span>
                            </td>
                          </tr>
                        </table>
                  ...
                  <table style="width: 25%; display: inline-block" valign="top">
                    <tr style="width: 100%">
                      <td
                        valign="bottom"
                        height="44px"
        ...
        <tr>
          <td style="padding: 24px">
            <table>
              ...
              <tr>
                <td>
                  <h3 style="margin-bottom: 8px">Dear ${category}!</h3>
                </td>
              ...
              <tr>
                <td>
                  <p style="font-size: 18px; line-height: 1.5">
                    We have a new form submission from our website complaint
                    form.
                  </p>
                </td>
              </tr>
